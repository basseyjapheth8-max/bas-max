import './Education.css'
    const educationData = [
      { id:1, degree:'B.Sc. Software Engineering', school:'Mountain Top University', year:'2020-2024', grade:'First Class Honours', emoji:'🎓' },
      { id:2, degree:'Web Development Bootcamp', school:'Andela Learning Community', year:'2023', grade:'Completed', emoji:'💻' },
      { id:3, degree:'WAEC / SSCE', school:'Shekinah Secondary School', year:'2020', grade:'8 distinctions', emoji:'📜' },
    ]
    function Education() {
      return (
